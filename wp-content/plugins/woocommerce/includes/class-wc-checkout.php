...
class WC_Checkout
{
    ...
    public static function instance()
    {
        if (is_null(self::$instance)) {
            ...
            add_action('woocommerce_checkout_loan', array(self::$instance, 'checkout_form_loan'));
    ...
    /**
     * Output the Loan Calculations.
     */
    public function checkout_form_loan()
    {
        wc_get_template('checkout/form-loan.php', array('checkout' => $this));
    }
